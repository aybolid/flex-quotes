...
const title: string = "Sign In Error - Flex Quotes";
const url: string = "https://flexquotes.vercel.app/auth/error";
...
export default function SignIn({
  ...
  const error = router.query as unknown as string;
  ...
  return (
    <>
      ...
      >
        ...
        >
          <section className="bg-zinc-800 rounded-md p-2 md:p-4 flex flex-col justify-center items-center gap-8 border border-red-500">
            ...
            <div className="flex flex-col justify-center items-center gap-4">
              <div className="bg-zinc-900 w-full p-2 md:p-4 rounded-md border border-dashed border-red-500">
                <p className="w-full text-center font-mono text-red-500">
